...
def test_empty_ticket():
    ...
    print("[PASS] C2 檢測：失敗（缺少驗收條件、測試規劃、工作日誌、參考文件）")
    ...
    print("[PASS] C3 檢測：失敗（無層級標示）")

    print("[PASS] 測試 1 通過：空內容 Ticket 處理正確")
...
def test_large_ticket():
    ...
    print(f"[PASS] 效能測試通過：執行時間 {execution_time:.3f}s < 2.0s")
    ...
    print("[PASS] 檢測結果正確：識別到 200 個檔案（超標）")

    print("[PASS] 測試 2 通過：超大 Ticket 處理正確且效能達標")
...
"""
    ...
    for expected_path in expected_paths:
        ...
        print(f"[PASS] 成功提取路徑: {expected_path}")

    print("[PASS] 測試 3 通過：特殊字元路徑處理正確")
...
"""
    ...
    print("[PASS] 驗收條件提取功能正確")

    print("[PASS] 測試 4 通過：多層級巢狀章節處理正確")
...
"""
    ...
    print("[PASS] 驗收條件提取正確（忽略表情符號）")

    print("[PASS] 測試 5 通過：Unicode 和表情符號處理正確")
...
"""
    ...
    print("[PASS] 情況 1 通過: Layer 0 驗收條件含關鍵詞時 acceptance_aligned = True")
...
"""
    ...
    print("[PASS] 情況 2 通過: Layer 0 驗收條件無關鍵詞時 acceptance_aligned = False")
...
"""
    ...
    print("[PASS] 情況 3 通過: Layer 0 的 11 個關鍵詞都被正確識別")

    print("[PASS] 測試 6 通過：Layer 0 Infrastructure 層級 C3 檢測正確")
...
def run_all_edge_case_tests():
    ...
    if failed == 0:
        print("[PASS] 所有邊界測試案例通過")
    else:
        print(f"[FAIL] {failed} 個測試案例失敗")
    print("="*60)
