...
============================================================"""
    ...
    # ========================================================================
    # 場景 C: Wave 完成審查提醒（決策樹 Checkpoint 2 情景 C）
    # ========================================================================

    WAVE_COMPLETION_REMINDER = """============================================================
[AskUserQuestion 強制提醒] Wave 完成審查（情景 C）
============================================================
...
[決策樹參考]：
  decision-tree.md - 第八層 Checkpoint 2（情景 C 的完整流程）

[AskUserQuestion 規則]：
  根據「情景 C1」或「情景 C2」選擇對應的 AskUserQuestion 場景。
